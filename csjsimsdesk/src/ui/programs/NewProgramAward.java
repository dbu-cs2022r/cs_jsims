 ...
 * @author ChalewT
 */
public class NewProgramAward extends javax.swing.JDialog {

    /**
     * Creates new form NewProgramAward
     */
    public NewProgramAward(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewProgramAward.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NewProgramAward dialog = new NewProgramAward(new javax.swing.JFrame(), true);
